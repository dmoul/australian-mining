...
Does volume go up when prices go up (mine owners are more motivated to produce more)? Or do prices go down when volume goes up (perhaps demand is satisfied, leading to lower prices)? The answer appears to be mixed. For some (Gold, Lithium, Chromium, Iron ore) demand and volume have been positively correlated in recent years. Some are negatively correlated (Uranium, Bauxite).
