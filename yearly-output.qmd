...
In @fig-amount-2021 the range of output varies by `r powers_of_ten` powers of 10: from `r comma(round(min(data_for_plot$mass)))` to `r comma(round(max(data_for_plot$mass)))`.
